...
public class ConceptWayfinder extends LinearOpMode {
    ...
    Wayfinder wayfinder = new Wayfinder(); //OpMode member for the point-to-point navigation class
        ...
        while (opModeIsActive()) {
            ...
            switch (stateMachine){
                ...
                case DRIVE_TO_TARGET_0:
                     ...
                     */
                    if (wayfinder.driveTo(pinpoint.getPosition(), TARGET_0, 0.7, 0)){
                ...
                case DRIVE_TO_TARGET_1:
                    ...
                    if (wayfinder.driveTo(pinpoint.getPosition(), TARGET_1, 0.7, 1)){
